...
@st.cache_resource
def get_connection():
  # ප්‍රයිවෙට් කේ එකේ බේස්-64 කොටස පමණක් ලබා දී, පයිතන් මඟින් නිවැරදි PEM ෆෝමැට් එකට ස්වයංක්‍රීයව සැකසීම
  raw_b64_key = (
  ...
  # අක්ෂර 64 බැගින් නිවැරදිව ලයින් කඩා PEM කේ එක සකස් කිරීම
  wrapped_key = "\n".join(textwrap.wrap(raw_b64_key, 64))
